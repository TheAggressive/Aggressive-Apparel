 ...
 *
 * This directory is mapped into wp-env as its development mu-plugin directory.
 * It is never loaded by the production theme and bin/ is removed from releases.
 *
...
$aggressive_apparel_e2e_query_value = static function ( string $key ): string {
	// Read-only, allowlisted E2E controls do not authenticate or mutate state.
