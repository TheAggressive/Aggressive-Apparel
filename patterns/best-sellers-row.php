...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--24);padding-bottom:var(--wp--preset--spacing--24)">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			...
			<p class="has-foreground-muted-color has-text-color has-medium-font-size"><?php echo esc_html__( 'The pieces our community keeps coming back for.', 'aggressive-apparel' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
