...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--24);padding-bottom:var(--wp--preset--spacing--24)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
			<!-- wp:cover {"dimRatio":0,"minHeight":500,"minHeightUnit":"px","isDark":false,"style":{"color":{"background":"var:preset|color|surface-elevated"}}} -->
			<div class="wp-block-cover is-light" style="background-color:var(--wp--preset--color--surface-elevated);min-height:500px">
				<span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span>
				<div class="wp-block-cover__inner-container">
					<!-- wp:paragraph {"align":"center","fontSize":"large"} -->
					<p class="has-text-align-center has-large-font-size">Lifestyle image placeholder</p>
					<!-- /wp:paragraph -->
				</div>
			</div>
			<!-- /wp:cover -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%">
			...
			<p class="has-accent-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.1em;text-transform:uppercase">Our Story</p>
			<!-- /wp:paragraph -->
			...
			<p class="has-medium-font-size" style="margin-top:var(--wp--preset--spacing--6);line-height:1.8">Aggressive Apparel was born from the belief that what you wear should match your ambition. Every piece is crafted with premium materials and built to perform — from the gym floor to the city streets.</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.8"}},"fontSize":"medium"} -->
			<p class="has-medium-font-size" style="line-height:1.8">We don't follow trends. We set them. Our designs are for the fearless, the driven, and the unapologetic.</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				...
				<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-black-background-color has-text-color has-background wp-element-button" style="padding-top:var(--wp--preset--spacing--3);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--3);padding-left:var(--wp--preset--spacing--8);font-style:normal;font-weight:600;letter-spacing:0.05em;text-transform:uppercase" href="/about">Learn More About Us</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
