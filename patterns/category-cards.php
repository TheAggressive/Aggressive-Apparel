 ...
 * Description: Visual grid of product category cards with images and overlay text links.
 * Slug: aggressive-apparel/category-cards
 * Categories: aggressive, aggressive-apparel, aggressive-products, aggressive-homepage
 * Keywords: categories, cards, grid, shop, collections, browse
 * Viewport Width: 1200
 *
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)">
	<!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|14"}}},"fontSize":"fluid-xxxx-large"} -->
	<h2 class="wp-block-heading has-text-align-center has-fluid-xxxx-large-font-size" style="margin-bottom:var(--wp--preset--spacing--14)">Shop by Category</h2>
	<!-- /wp:heading -->
	...
	<!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|6"},"margin":{"top":"var:preset|spacing|6"}}}} -->
