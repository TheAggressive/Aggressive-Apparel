<?php
/**
 * Title: Collection Drop Hype
 * Description: Urgency-driven section for upcoming collection drops with massive typography and hype-building CTA.
 * Slug: aggressive-apparel/collection-drop-hype
 * Categories: aggressive, aggressive-apparel, aggressive-conversion, aggressive-homepage
 * Keywords: drop, collection, coming soon, hype, countdown, launch, release
 * Viewport Width: 1400
 *
...
<div class="wp-block-group">
	...
	<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color has-fluid-xxxxxxxxx-large-font-size" style="margin-top:var(--wp--preset--spacing--6);font-style:normal;font-weight:900;line-height:0.95;text-transform:uppercase">Nightfall Collection</h1>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|8"}},"typography":{"textTransform":"uppercase","letterSpacing":"0.15em","fontStyle":"normal","fontWeight":"500"}},"textColor":"white","fontSize":"large"} -->
	<p class="has-text-align-center has-white-color has-text-color has-large-font-size" style="margin-top:var(--wp--preset--spacing--8);font-style:normal;font-weight:500;letter-spacing:0.15em;text-transform:uppercase">March 15, 2026 — 12:00 PM EST</p>
	<!-- /wp:paragraph -->

	<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|4"}}},"textColor":"white","fontSize":"medium"} -->
	<p class="has-text-align-center has-white-color has-text-color has-medium-font-size" style="margin-top:var(--wp--preset--spacing--4)">Limited quantities. Once they're gone, they're gone.</p>
	<!-- /wp:paragraph -->
...
<!-- wp:columns {"align":"full","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|4","top":"0"},"margin":{"top":"var:preset|spacing|4","bottom":"0"}}}} -->
