...
?><!-- wp:cover {"dimRatio":30,"overlayColor":"black","minHeight":80,"minHeightUnit":"vh","contentPosition":"bottom left","align":"full","isDark":true,"style":{"color":{"background":"var:preset|color|black"},"spacing":{"padding":{"top":"var:preset|spacing|12","bottom":"var:preset|spacing|12","left":"var:preset|spacing|12","right":"var:preset|spacing|12"},"margin":{"top":"0","bottom":"0"}}}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				...
				<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-black-background-color has-text-color has-background wp-element-button" href="/lookbook"><?php echo esc_html__( 'View Full Lookbook', 'aggressive-apparel' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
			</div>
...
<!-- wp:columns {"align":"full","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|4","top":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
