...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0">
	...
	<div class="wp-block-columns is-stacked-on-mobile">
		...
		<div class="wp-block-column has-black-background-color has-background" style="padding-top:var(--wp--preset--spacing--16);padding-right:var(--wp--preset--spacing--12);padding-bottom:var(--wp--preset--spacing--16);padding-left:var(--wp--preset--spacing--12);flex-basis:50%">
			...
			<p class="has-accent-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.2em;text-transform:uppercase"><?php echo esc_html__( 'Ends Tonight', 'aggressive-apparel' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<h1 class="wp-block-heading has-white-color has-text-color has-fluid-xxxxxxxxx-large-font-size" style="margin-top:var(--wp--preset--spacing--4);font-style:normal;font-weight:900;line-height:0.85;text-transform:uppercase"><?php echo esc_html__( 'Flash Sale', 'aggressive-apparel' ); ?></h1>
			<!-- /wp:heading -->
			...
			<p class="has-white-color has-text-color has-large-font-size" style="margin-top:var(--wp--preset--spacing--8);font-style:normal;font-weight:600;letter-spacing:0.1em;text-transform:uppercase"><?php echo esc_html__( 'Ends at midnight', 'aggressive-apparel' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<p class="has-white-color has-text-color has-medium-font-size" style="margin-top:var(--wp--preset--spacing--4)"><?php echo esc_html__( 'Up to 40% off select streetwear. No code needed — prices already slashed.', 'aggressive-apparel' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
