...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0">
	...
	<div class="wp-block-columns are-vertically-aligned-center is-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--12);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--12);flex-basis:45%">
			...
			<p class="has-accent-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.15em;text-transform:uppercase">Product Spotlight</p>
			<!-- /wp:paragraph -->
			...
			<p class="has-large-font-size" style="margin-top:var(--wp--preset--spacing--6);font-style:normal;font-weight:600;letter-spacing:0.05em;text-transform:uppercase">From $98</p>
			<!-- /wp:paragraph -->
			...
			<p class="has-foreground-muted-color has-text-color has-medium-font-size" style="margin-top:var(--wp--preset--spacing--6);line-height:1.7">450gsm French terry. Oversized fit. Reinforced kangaroo pocket. The hoodie that started it all — re-engineered for SS26.</p>
			<!-- /wp:paragraph -->
