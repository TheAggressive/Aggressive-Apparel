...
<div class="wp-block-group">
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--10)">
		...
		<div class="wp-block-button is-style-cta"><a class="wp-block-button__link has-white-color has-accent-background-color has-text-color has-background wp-element-button" href="/shop"><?php echo esc_html__( 'Shop the Collection', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"textColor":"white","className":"is-style-cta-outline-on-dark"} -->
		<div class="wp-block-button is-style-cta-outline-on-dark"><a class="wp-block-button__link has-white-color has-text-color wp-element-button" href="/lookbook"><?php echo esc_html__( 'Watch the Film', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
