...
<!-- wp:cover {"dimRatio":75,"overlayColor":"black","isUserOverlayColor":true,"minHeight":85,"minHeightUnit":"vh","contentPosition":"center center","align":"full","isDark":true,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"background":"var:preset|color|black"}}} -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--10)">
		...
		<div class="wp-block-button is-style-cta"><a class="wp-block-button__link has-white-color has-accent-background-color has-text-color has-background wp-element-button" href="/shop"><?php echo esc_html__( 'Shop the Drop', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"textColor":"white","className":"is-style-cta-outline-on-dark"} -->
		<div class="wp-block-button is-style-cta-outline-on-dark"><a class="wp-block-button__link has-white-color has-text-color wp-element-button" href="/product-category/hoodies"><?php echo esc_html__( 'View Hoodies', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--24);padding-bottom:var(--wp--preset--spacing--24)">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-black-background-color has-text-color has-background wp-element-button" href="/shop?orderby=date"><?php echo esc_html__( 'View All', 'aggressive-apparel' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				<!-- wp:button {"backgroundColor":"black","textColor":"white"} -->
				<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-black-background-color has-text-color has-background wp-element-button" href="/lookbook"><?php echo esc_html__( 'View Lookbook', 'aggressive-apparel' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--12);padding-bottom:var(--wp--preset--spacing--24)">
	...
	<div class="wp-block-buttons">
		<!-- wp:button {"backgroundColor":"black","textColor":"white"} -->
		<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-black-background-color has-text-color has-background wp-element-button" href="https://instagram.com/aggressiveapparel"><?php echo esc_html__( 'Follow @AggressiveApparel', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
