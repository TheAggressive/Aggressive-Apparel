...
<div class="wp-block-columns alignfull" style="margin-top:0;margin-bottom:0">
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-cover is-dark" style="background-color:var(--wp--preset--color--black);min-height:65vh"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-45 has-background-dim"></span><div class="wp-block-cover__inner-container">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				...
				<div class="wp-block-button is-style-outline-on-dark"><a class="wp-block-button__link has-white-color has-text-color wp-element-button" href="/shop/men"><?php echo esc_html__( 'Shop Men\'s', 'aggressive-apparel' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div></div>
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-cover is-dark" style="background-color:var(--wp--preset--color--surface-elevated);min-height:65vh"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-45 has-background-dim"></span><div class="wp-block-cover__inner-container">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				<!-- wp:button {"textColor":"white","className":"is-style-outline-on-dark"} -->
				<div class="wp-block-button is-style-outline-on-dark"><a class="wp-block-button__link has-white-color has-text-color wp-element-button" href="/shop/women"><?php echo esc_html__( 'Shop Women\'s', 'aggressive-apparel' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div></div>
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover is-dark has-custom-content-position is-position-bottom-center" style="background-color:var(--wp--preset--color--black);min-height:360px"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-40 has-background-dim"></span><div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--4)">
					<!-- wp:button {"className":"is-style-cta-small-outline-on-dark"} -->
					<div class="wp-block-button is-style-cta-small-outline-on-dark"><a class="wp-block-button__link wp-element-button" href="/product-category/bottoms"><?php echo esc_html__( 'Shop Bottoms', 'aggressive-apparel' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div></div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover is-dark has-custom-content-position is-position-bottom-center" style="background-color:var(--wp--preset--color--surface-elevated);min-height:360px"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-40 has-background-dim"></span><div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--4)">
					<!-- wp:button {"className":"is-style-cta-small-outline-on-dark"} -->
					<div class="wp-block-button is-style-cta-small-outline-on-dark"><a class="wp-block-button__link wp-element-button" href="/product-category/accessories"><?php echo esc_html__( 'Shop Accessories', 'aggressive-apparel' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div></div>
...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--24);padding-bottom:var(--wp--preset--spacing--24)">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-accent-background-color has-text-color has-background wp-element-button" href="/shop"><?php echo esc_html__( 'View All', 'aggressive-apparel' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
