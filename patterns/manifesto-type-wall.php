...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--28);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--28);padding-left:var(--wp--preset--spacing--8)">
	...
	<p class="has-accent-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.18em;text-transform:uppercase">Manifesto</p>
	<!-- /wp:paragraph -->
	...
	<h2 class="wp-block-heading has-fluid-xxxxxxxxx-large-font-size" style="margin-top:var(--wp--preset--spacing--10);font-style:normal;font-weight:900;line-height:0.92;text-transform:uppercase">We don't do soft.</h2>
	<!-- /wp:heading -->
	...
	<h2 class="wp-block-heading has-foreground-muted-color has-text-color has-fluid-xxxxxx-large-font-size" style="margin-top:var(--wp--preset--spacing--4);font-style:normal;font-weight:300;line-height:0.95">We cut heavyweight blanks, print what we mean,</h2>
	<!-- /wp:heading -->
	...
	<h2 class="wp-block-heading has-fluid-xxxxxx-large-font-size" style="margin-top:var(--wp--preset--spacing--2);font-style:normal;font-weight:800;line-height:0.95;text-transform:uppercase">and ship it before the hype cools.</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-group">
		...
		<p class="has-foreground-muted-color has-text-color has-medium-font-size" style="line-height:1.6">Street-tested fits. Limited runs. No filler drops.</p>
		<!-- /wp:paragraph -->
		...
		<p class="has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.08em;text-transform:uppercase"><a href="/about">Read the story →</a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
