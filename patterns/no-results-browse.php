...
?><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|24"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--24)">
	...
	<div class="wp-block-buttons" style="margin-bottom:var(--wp--preset--spacing--16)">
		<!-- wp:button {"backgroundColor":"surface-elevated","textColor":"foreground","className":"is-style-ghost"} -->
		<div class="wp-block-button is-style-ghost"><a class="wp-block-button__link has-foreground-color has-surface-elevated-background-color has-text-color has-background wp-element-button" href="/product-category/hoodies"><?php echo esc_html__( 'Hoodies', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"backgroundColor":"surface-elevated","textColor":"foreground","className":"is-style-ghost"} -->
		<div class="wp-block-button is-style-ghost"><a class="wp-block-button__link has-foreground-color has-surface-elevated-background-color has-text-color has-background wp-element-button" href="/product-category/tees"><?php echo esc_html__( 'Tees', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"backgroundColor":"surface-elevated","textColor":"foreground","className":"is-style-ghost"} -->
		<div class="wp-block-button is-style-ghost"><a class="wp-block-button__link has-foreground-color has-surface-elevated-background-color has-text-color has-background wp-element-button" href="/product-category/bottoms"><?php echo esc_html__( 'Bottoms', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
