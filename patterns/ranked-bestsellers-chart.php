...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--24);padding-bottom:var(--wp--preset--spacing--24)">
	...
	<p class="has-accent-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.14em;text-transform:uppercase"><?php echo esc_html__( 'This week', 'aggressive-apparel' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:heading {"style":{"spacing":{"margin":{"top":"var:preset|spacing|3","bottom":"var:preset|spacing|14"}}},"fontSize":"fluid-xxxx-large"} -->
	<h2 class="wp-block-heading has-fluid-xxxx-large-font-size" style="margin-top:var(--wp--preset--spacing--3);margin-bottom:var(--wp--preset--spacing--14)"><?php echo esc_html__( 'Most wanted', 'aggressive-apparel' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--border);border-top-width:1px;padding-top:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8)">
		...
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:48%">
				...
				<h3 class="wp-block-heading has-x-large-font-size" style="font-style:normal;font-weight:700"><?php echo esc_html__( 'Hand-pick #1 in the collection', 'aggressive-apparel' ); ?></h3>
				<!-- /wp:heading -->
				...
				<p class="has-foreground-muted-color has-text-color has-small-font-size" style="margin-top:var(--wp--preset--spacing--2);line-height:1.6"><?php echo esc_html__( 'Replace this row\'s product collection with a single hand-picked SKU.', 'aggressive-apparel' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
...
<!-- /wp:woocommerce/product-collection -->
	...
	<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--border);border-top-width:1px;padding-top:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8)">
		...
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:48%">
				<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"x-large"} -->
				<h3 class="wp-block-heading has-x-large-font-size" style="font-style:normal;font-weight:700"><?php echo esc_html__( 'Hand-pick #2 in the collection', 'aggressive-apparel' ); ?></h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|2"}},"typography":{"lineHeight":"1.6"}},"textColor":"foreground-muted","fontSize":"small"} -->
				<p class="has-foreground-muted-color has-text-color has-small-font-size" style="margin-top:var(--wp--preset--spacing--2);line-height:1.6"><?php echo esc_html__( 'Offset this query or pick a specific product so the chart stays intentional.', 'aggressive-apparel' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
...
<!-- /wp:woocommerce/product-collection -->
	...
	<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--border);border-top-width:1px;border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8)">
		...
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:48%">
				<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"x-large"} -->
				<h3 class="wp-block-heading has-x-large-font-size" style="font-style:normal;font-weight:700"><?php echo esc_html__( 'Hand-pick #3 in the collection', 'aggressive-apparel' ); ?></h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|2"}},"typography":{"lineHeight":"1.6"}},"textColor":"foreground-muted","fontSize":"small"} -->
				<p class="has-foreground-muted-color has-text-color has-small-font-size" style="margin-top:var(--wp--preset--spacing--2);line-height:1.6"><?php echo esc_html__( 'Keep the chart short — three to five rows reads stronger than a full grid.', 'aggressive-apparel' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
...
<!-- /wp:woocommerce/product-collection -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--12)">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-surface-color has-foreground-background-color has-text-color has-background wp-element-button" style="padding-top:var(--wp--preset--spacing--3);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--3);padding-left:var(--wp--preset--spacing--8);font-style:normal;font-weight:700;letter-spacing:0.06em;text-transform:uppercase" href="/shop?orderby=popularity"><?php echo esc_html__( 'Shop all bestsellers', 'aggressive-apparel' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
