	...
	<div class="wp-block-columns are-vertically-aligned-center" style="margin-bottom:var(--wp--preset--spacing--20)">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:42%">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				...
				<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-accent-background-color has-text-color has-background wp-element-button" href="/shop"><?php echo esc_html__( 'View product', 'aggressive-apparel' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
...
<!-- /wp:woocommerce/product-collection -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:42%">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				...
				<div class="wp-block-button is-style-ghost"><a class="wp-block-button__link wp-element-button" href="/shop"><?php echo esc_html__( 'View product', 'aggressive-apparel' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
