	...
	<div class="wp-block-aggressive-apparel-split-story aa-split-story aa-split-story--media-left aa-split-story--viewport aa-split-story--sticky aa-split-story--stack-media-first alignwide" style="--aa-split-media-width:48%;--aa-split-gap:var(--wp--preset--spacing--10) var(--wp--preset--spacing--14)">
		...
		<div class="wp-block-aggressive-apparel-split-story-media aa-split-story__media">
			...
			<div class="wp-block-cover is-dark" style="background-color:var(--wp--preset--color--black);min-height:100%"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-25 has-background-dim"></span><div class="wp-block-cover__inner-container">
				...
				<p class="has-text-align-center has-white-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.16em;text-transform:uppercase">Studio still</p>
				<!-- /wp:paragraph -->
			</div></div>
			<!-- /wp:cover -->
		</div>
		...
		<div class="wp-block-aggressive-apparel-split-story-content aa-split-story__content">
			...
			<p class="has-accent-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.14em;text-transform:uppercase">Inside the room</p>
			<!-- /wp:paragraph -->
			...
			<h2 class="wp-block-heading has-fluid-xxxx-large-font-size" style="margin-top:var(--wp--preset--spacing--4);font-style:normal;font-weight:800;line-height:1.1">Midnight fittings, last-call dye runs</h2>
			<!-- /wp:heading -->
			...
			<p class="has-foreground-muted-color has-text-color has-medium-font-size" style="margin-top:var(--wp--preset--spacing--8);line-height:1.75">Most of what you see on the product page started as a pile of rejected samples on a folding table. We keep the rejects nearby on purpose — they remind the room what almost shipped.</p>
			<!-- /wp:paragraph -->
			...
			<p class="has-foreground-muted-color has-text-color has-medium-font-size" style="margin-top:var(--wp--preset--spacing--6);line-height:1.75">Heavyweight fleece only stays in the line if it survives a wash cycle without losing the print edge. If the hand-feel goes soft in the wrong way, the blank is out.</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|6"}},"typography":{"lineHeight":"1.75"}},"textColor":"foreground-muted","fontSize":"medium"} -->
			<p class="has-foreground-muted-color has-text-color has-medium-font-size" style="margin-top:var(--wp--preset--spacing--6);line-height:1.75">When a drop finally clears, we photograph it the same night. No lifestyle set dressing — just the piece, the light we have, and the deadline.</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--12)">
				...
				<div class="wp-block-button"><a class="wp-block-button__link has-surface-color has-foreground-background-color has-text-color has-background wp-element-button" style="padding-top:var(--wp--preset--spacing--3);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--3);padding-left:var(--wp--preset--spacing--8);font-style:normal;font-weight:700;letter-spacing:0.06em;text-transform:uppercase" href="/journal">More from the journal</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
