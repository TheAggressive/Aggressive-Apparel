...
export function AosInspector({
  ...
  return (
    <InspectorControls>
      ...
      {/* Timing Panel */}
      <PanelBody title={__('Timing', 'aggressive-apparel')} initialOpen={false}>
        <RangeControl
        ...
        {attributes.staggerChildren && (
          <>
            ...
            {attributes.staggerPattern === 'wave' && (
              <>
                ...
                <RangeControl
                  ...
                  max={1}
                  step={0.1}
                  help={__('Base delay for wave pattern', 'aggressive-apparel')}
                />
              </>
            )}
            ...
            {attributes.staggerPattern === 'random' && (
              <>
                <RangeControl
                  label={__('Min Random Delay (seconds)', 'aggressive-apparel')}
                ...
                />
                <RangeControl
                  label={__('Max Random Delay (seconds)', 'aggressive-apparel')}
