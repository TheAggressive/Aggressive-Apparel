...
$close_button_html = sprintf(
	'<button type="button" class="aa-nav__panel-close aa-icon-button aa-icon-button--only aa-icon-button--square" aria-label="%s" data-wp-on--click="actions.close"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6L6 18M6 6l12 12"/></svg></button>',
