  ...
  'aggressive-apparel/predictive-search',
  {
    state: {
      get isNotLoading(): boolean {
        return !getContext<PredictiveSearchContext>().isLoading;
      },
      get hasNoProducts(): boolean {
        return getContext<PredictiveSearchContext>().products.length === 0;
      },
      get hasNoCategories(): boolean {
        return getContext<PredictiveSearchContext>().categories.length === 0;
      },
      ...
      get ariaExpanded(): string {
        return getContext<PredictiveSearchContext>().isOpen ? 'true' : 'false';
      },
      ...
      get query(): string {
        return getContext<PredictiveSearchContext>().query;
      },
    },
