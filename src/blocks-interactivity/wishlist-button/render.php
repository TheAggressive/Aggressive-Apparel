...
// Media action stack already owns the listing-card heart.
if ( Feature_Settings::quick_view_includes_wishlist() && Product_Context::is_product_listing() ) {
	return;
}
...
$icon_html = '';
if ( $show_icon ) {
	$icon_html = Wishlist::get_toggle_icon_html();
}
